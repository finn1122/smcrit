...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="card">
                <h5 class="card-header alert-info">Agregar ubicación</h5>
                <div class="card-body">
                    <form method="POST" action="../controladores/agregarUbicacion.php">
                    <input type="hidden" name="fl_ubicacion" />
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="text">Ubicación</label>
                                <input type="text" class="form-control" name="nb_ubicacion" required placeholder="Ubicación">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="text" >No. Oficina</label>
                                <input type="text" class="form-control" name="no_oficina" required placeholder="Número de oficina">
                            </div>
                        </div>
                    <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select name="fl_crit" class="form-control">
                                    ...
                                    while ($valores = mysqli_fetch_array($query)) {
                                        echo '<option value="' . $valores[fl_crit] . '">' . $valores[nb_crit] . '</option>';
                                    }
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" class="form-control" name="ds_ubicacion" required placeholder="Descripción">
                            </div>
                    </div>    
